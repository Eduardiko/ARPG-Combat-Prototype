...
public class Jovani : MonoBehaviour
{
    ...
    void Update()
    {
        if (timer > 2.0f)
        {
            ...
            vector = new Vector3(topPoint.position.x, topPoint.position.y, topPoint.position.z);
            ...
            response = Vector3.ProjectOnPlane(vector, transform.position);
